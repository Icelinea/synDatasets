...
class Agent():
    ...
    def chat(self, history):
        ...
        if self.role == "patient":
            ...
            genPrompt += "按照患者所提供的背景，当前的患者核心病症主题应该是{}。你作为心理健康领域医生需要坚持向患者探讨这个主题，尽量不要被带偏，直到患者的心理问题得到改善。你可以向患者提出问题来进一步了解患者的内心想法，也可以回答患者提出的问题。如果你认为当前主题已经探讨完全或者患者的心理问题得到了很大的改善，只需要回答\"EOF\"就会终止对话，不需要回复其他任何东西。注意字数需要控制在 10 到 100 个中文字数之间。注意使用一定要使用口语化的表达。".format(self.background["主题"])
        assert genPrompt != ""
